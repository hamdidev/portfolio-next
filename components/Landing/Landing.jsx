      ...
      <div className="editor-block">
        <div className="code code-css">
          ...
          <div className="code-content">
            <code>
              <p className="line-1">
                <span className="c-y line-1-y">.whoAmI?</span> &#123;
              </p>
              <br />

              <p className="line-2">
                <span className="c-y line-2-2"> Muhammed HALAF</span> &#40;
              </p>

              <br />
              <p className="line-3">
                <span className="c-o">developer</span>,
              </p>
              <br />
              <p className="line-4">
                <span className="c-y designer">designer</span>,
              </p>
              <br />
              <p className="line-5">
                <span className="c-y freelancer">freelancer</span> &#41; &#125;
              </p>
            </code>
          </div>
        </div>
